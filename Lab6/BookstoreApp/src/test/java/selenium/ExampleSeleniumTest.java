...
class ExampleSeleniumTest {
  ...
  @Test
  public void testingLanguages() {
    WebElement search = driver.findElement(By.id("searchBtn"));
    search.click();
    WebElement cart = driver.findElement(By.className("content"));
    String expected = cart.findElement(By.tagName("h1")).getText();
    assertEquals(expected, "Nous avons actuellement les articles suivants dans la catégorie ''");
